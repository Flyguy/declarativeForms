...
class Choices implements IChoices {
    ...
    public function __construct($iterator, $value_key, $text_key = NULL) {
        $this->iterator = $iterator;
        $this->value_key = $value_key;
        $this->text_key = $text_key;
    }

    protected function lazy_load() {
        if(!is_array($this->choices)) {
            $this->choices = Array();
            foreach($this->iterator as $obj) {
                $this->choices[$obj[$this->value_key]] = $this->get_text($obj);
            }
            return true;
        }
        return false;
    ...
    protected function get_text($item) {
